...
<Header></Header> 
          ...
          description='Desarrollamos en React JS' 
          image='dev'
          alt='imagen relacionada'>
          </Services>
          <Services 
          service='Diseño Grafico' 
          description='Realizamos trabajos de diseno grafico' 
          image='design'
          alt='imagen relacionada'>
          </Services>
          ...
          <Services
          service='Fotografia'
          description='Realizamos fotografia profesional para catalogos'
          image='photo'
          alt='imagen relacionada'></Services>
        
          <Routes>
            <Route path='home' element={A}/>
            <Route path='home' element={B}/>
